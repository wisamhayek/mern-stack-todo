...
export default function AllTasks() {
    ...
    function getTasks(){
        axios.get("https://midtermtodo.herokuapp.com/api/v1/tasks/byUser",{
            headers: {
                ownerid: user.id
            }
        }).then((response)=>{
    ...
    function deleteTasks(x){
        setData([])
        axios.delete("https://midtermtodo.herokuapp.com/api/v1/tasks/byUser",{
            headers: {
                taskid: x
            }
        }).then((response)=>{
    ...
    function updateTaskTitle(x){
        axios.put("https://midtermtodo.herokuapp.com/api/v1/tasks/byUser",{},{
            headers: {
                taskid: x,
                newtitle: title
            }
